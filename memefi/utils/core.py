...
def main():
    clear_screen()
    print_banner()
    energy_booster = config.get('energy_booster', True)
    turbo_booster = config.get('turbo_booster', True)
    auto_claim_combo = config.get('auto_claim_combo', True)
    crazy_damage = config.get('crazy_damage',True)
